	...
	<html>
		...
		<body>
			<div class="content-compartir-club">
				...
				height: 1024px; width: 500px; float:left; background-position:top center;
					background-image: url('.getTema().'/images/club-patitas/Kmimos-Club-de-las-patitas-felices-1.jpg);
				"></div>
				<div class="col-xs-12 col-sm-12 col-md-7 compartir-section" style="height: 500px; width: 500px; float:left;">
