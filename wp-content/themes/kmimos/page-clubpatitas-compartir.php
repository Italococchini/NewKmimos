					...
					<div class="col-md-12">
						...
						<div id="redes-sociales" class="row text-center" style="margin: 30px 0px 0px 0px; background: #e8e8e8; border-radius: 5px; padding: 10px 0px; display:none;">
							...
							<div style="margin-top: 10px;" class="col-md-4 col-sm-12 col-xs-12 text-center">
								...
								<div class="fb-share-button" data-href="https://kmimos.com.mx" data-layout="button" data-size="small" data-mobile-iframe="true"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fkmimos.com.mx%2F&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Compartir</a></div> 
							</div>
							<div style="margin-top: 10px;" class="col-md-4 col-sm-12 col-xs-12 text-center">
