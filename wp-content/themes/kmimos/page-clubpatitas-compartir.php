			...
			<div class="col-md-8 col-md-offset-2">
				...
				<div class="row">
					...
					<div id="redes-sociales" class="row text-center" style="margin: 30px 0px 0px 0px; background: #e8e8e8; border-radius: 5px; padding: 10px 0px; display:none;">
						...
						<div class="col-md-4 col-sm-6 col-xs-6 text-center">
							<a style="color: #fff!important; font-size:11px; font-weight: bold; background: #25D366!important;"  class="btn btn-sm" href="https://api.whatsapp.com/send?text=Suma%20huellas%20y%20gana%20descuentos%20CUPON%20<?php echo strtoupper($cupon);?>"><i class="fa fa-whatsapp"></i> +52 1 55 6560 2472</a>
						</div>
					</div>
					<!-- FIN Compartir -->
